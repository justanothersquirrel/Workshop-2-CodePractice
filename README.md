...
It seems that the circles are shown between all browsing users to the server.

^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ The **issues** and this is not an issue, but maybe thats what makes an issue an issue is when it doesnt go the way it was planned to do so. bakc to the techincal issues I shall fix with more knwoeldge in the future:
